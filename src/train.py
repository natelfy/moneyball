...
def train_model(df: pd.DataFrame) -> Pipeline:
    ...
    # Enrichissement sabermétrique (OBP, K%, BB/K, ...) avant modélisation.
    df = add_sabermetric_features(df)

    # Séparation Features (X) et Target (y). On sélectionne explicitement les
    # colonnes du vecteur modèle pour garantir la parité avec l'inférence.
